...
from reviewcopies.views.timeslots import TimeslotsByScheduleView, TimeslotsCreateView, TimeslotsByScheduleUuidView, AvailableTimeSlotView
...
urlpatterns = [
    ...
    path('<uuid:uuid>/available/', AvailableTimeSlotView.as_view(), name='user-registration'),
