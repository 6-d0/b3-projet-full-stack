  ...
  <div class="container mx-auto p-6">
    ...
    <ul class="space-y-4">
      <li
        ...
        :key="session.slug"
        class="p-4 bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 transition-all"
      >
        <NuxtLink
